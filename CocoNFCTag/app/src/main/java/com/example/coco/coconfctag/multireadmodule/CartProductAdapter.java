...
public class CartProductAdapter extends RecyclerView.Adapter<CartProductAdapter.MyViewHolders> {
    ...
    public class MyViewHolders extends RecyclerView.ViewHolder {
        ...
        public ImageView plusBtn, minusBtn, removeBtn, indicatorImg;
    ...
    public CartProductAdapter(Context c, ArrayList<ProductItem> list, QuantityListener listener, WishlistListener wishlistLis, IndividualItemListener individualListener) {
    ...
    public CartProductAdapter(Context c, ArrayList<ProductItem> list, QuantityListener listener,IndividualItemListener individualListener) {
        this.productList = list;
        this.context = c;
        this.quantityListener = listener;
        this.prefs = context.getSharedPreferences("cocosoft", MODE_PRIVATE);
